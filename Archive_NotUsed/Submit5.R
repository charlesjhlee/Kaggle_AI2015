...
fit.all <- train(DEATHS ~ #AREA_SQKM
                 ...
                 , method = 'glmStepAIC', data = traindata, trControl = train_control)
...
write.table (submit[c("id","DEATHS")], sep=",", file = "c:/kaggle/data/submit4.csv", col.names=TRUE, row.names = FALSE)
